...
class MidiPlayerTab(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.playHotkeyLabel.grid(
            row=4, column=0, padx=(0, 300), pady=(0, 0), sticky="s"
        )
        ...
        self.playHotkeyButton.grid(
            row=4, column=0, padx=(0, 165), pady=(0, 0), sticky="s"
        )
        ...
        self.pauseHotkeyLabel.grid(
            row=5, column=0, padx=(0, 300), pady=(2, 30), sticky="s"
        )
        ...
        self.pauseHotkeyButton.grid(
            row=5, column=0, padx=(0, 165), pady=(0, 30), sticky="s"
        )
        ...
        self.slowDownHotkeyLabel.grid(
            row=5, column=0, padx=(80, 0), pady=(0, 30), sticky="s"
        )
        ...
        self.speedUpHotkeyButton.grid(
            row=5, column=0, padx=(250, 0), pady=(0, 30), sticky="s"
        )
        ...
        self.speedUpHotkeyLabel.grid(
            row=5, column=0, padx=(80, 0), pady=(0, 0), sticky="s"
        )
        ...
        self.slowHotkeyButton.grid(
            row=5, column=0, padx=(250, 0), pady=(0, 0), sticky="s"
        )
        ...
        self.sustainToggle.grid(
            row=4, column=0, padx=(40, 0), pady=(10, 0), sticky="nw"
        )
        ...
        self.noDoublesToggle.grid(
            row=4, column=0, padx=(40, 0), pady=(40, 0), sticky="nw"
        )
        ...
        self.velocityToggle.grid(
            row=4, column=0, padx=(40, 0), pady=(70, 0), sticky="nw"
        )
        ...
        self.use88KeysToggle.grid(
            row=4, column=0, padx=(40, 0), pady=(100, 10), sticky="nw"
        )
        self.__class__.use88KeysToggle = self.use88KeysToggle
        ToolTip.CreateToolTip(
            self.use88KeysToggle,
            text='Simulate LowNote and HighNote by "CTRL"\nOnly works on supported games.',
        )
