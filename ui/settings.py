...
class SettingsTab(ctk.CTkFrame):
    def __init__(self, master):
        ...
        self.midiModuleSelector = ctk.CTkOptionMenu(
            self.mainScrollFrame, width=170, command=settingsFunctions.midiModuleSelect, values=["pynput", "keyboard", "win32msg"], 
        ...
        self.__class__.midiModuleSelector = self.midiModuleSelector
        ...
        # Target Window selector (win32msg mode) — placed on row 7 right side
        if osName == "Windows":
            self.midiTargetWindowLabel = ctk.CTkLabel(
                self.mainScrollFrame, text="Target Window", fg_color="transparent",
                font=customTheme.globalFont14,
                text_color=customTheme.activeThemeData["Theme"]["Settings"]["TextColor"]
            )
            self.midiTargetWindowLabel.grid(row=6, column=0, padx=(0, 180), pady=(0, 70), sticky="es")
            self.__class__.midiTargetWindowLabel = self.midiTargetWindowLabel

            self.midiTargetWindowDropdown = ctk.CTkOptionMenu(
                self.mainScrollFrame, width=280, values=["\u2014 select a window \u2014"],
                command=settingsFunctions.midiOnTargetWindowSelect,
                font=customTheme.globalFont14, dropdown_font=customTheme.globalFont14,
                fg_color=customTheme.activeThemeData["Theme"]["Settings"]["OptionBackColor"],
                dropdown_fg_color=customTheme.activeThemeData["Theme"]["Settings"]["OptionDropdownBackground"],
                button_color=customTheme.activeThemeData["Theme"]["Settings"]["OptionDropdownButtonColor"],
            ...
            self.midiTargetWindowDropdown.grid(row=6, column=0, padx=(0, 35), pady=(0, 43), sticky="es")
            self.__class__.midiTargetWindowDropdown = self.midiTargetWindowDropdown
            ToolTip.CreateToolTip(self.midiTargetWindowDropdown, text='Window to send keystrokes to (win32msg only)')

            self.midiRefreshTargetWindowsBtn = ctk.CTkButton(
                self.mainScrollFrame, image=customTheme.resetImageCTk, text="", width=30,
                command=settingsFunctions.midiRefreshTargetWindows,
                font=customTheme.globalFont14,
                fg_color=customTheme.activeThemeData["Theme"]["Settings"]["ButtonColor"],
                hover_color=customTheme.activeThemeData["Theme"]["Settings"]["ButtonHoverColor"],
                text_color=customTheme.activeThemeData["Theme"]["Settings"]["TextColor"],
            ...
            self.midiRefreshTargetWindowsBtn.grid(row=6, column=0, padx=(0, 0), pady=(0, 43), sticky="es")
            self.__class__.midiRefreshTargetWindowsBtn = self.midiRefreshTargetWindowsBtn
            ToolTip.CreateToolTip(self.midiRefreshTargetWindowsBtn, text='Refresh window list')

            settingsFunctions.midiUpdateTargetWindowWidgets()

        # MIN & MAX SEEK DELAY SECTION (row 7)
        self.midiMinSeekDelayLabel = ctk.CTkLabel(
            self.mainScrollFrame, text="Min Seek Delay (s)", fg_color="transparent", 
            font=customTheme.globalFont14, 
            text_color=customTheme.activeThemeData["Theme"]["Settings"]["TextColor"]
        )
        self.midiMinSeekDelayLabel.grid(row=7, column=0, padx=(25, 0), pady=(5, 0), sticky="nw")

        self.midiMinSeekDelaySlider = ctk.CTkSlider(
            self.mainScrollFrame, from_=0.0, to=10.0, width=190, command=lambda value: settingsFunctions.updateFromSlider("midiMinSeekDelay", value), 
            fg_color=customTheme.activeThemeData["Theme"]["Settings"]["SliderBackColor"], 
            progress_color=customTheme.activeThemeData["Theme"]["Settings"]["SliderFillColor"], 
            button_color=customTheme.activeThemeData["Theme"]["Settings"]["SliderCircleColor"], 
            button_hover_color=customTheme.activeThemeData["Theme"]["Settings"]["SliderCircleHoverColor"]
        )
        self.midiMinSeekDelaySlider.grid(row=7, column=0, padx=(20,0), pady=(42, 0), sticky="nw")
        self.midiMinSeekDelaySlider.set(configuration.configData.get('midiPlayer', {}).get('minSeekDelay', 2.0))
        self.__class__.midiMinSeekDelaySlider = self.midiMinSeekDelaySlider
        ToolTip.CreateToolTip(self.midiMinSeekDelaySlider, text = 'Minimum random delay (seconds) when seeking')

        self.midiResetMinSeekDelay = ctk.CTkButton(
            self.mainScrollFrame, image=customTheme.resetImageCTk, text="", width=30, 
            command=lambda: settingsFunctions.resetControl("midiMinSeekDelay"), font=customTheme.globalFont14, 
            text_color=customTheme.activeThemeData["Theme"]["Settings"]["TextColor"], 
            fg_color=customTheme.activeThemeData["Theme"]["Settings"]["ButtonColor"], 
            hover_color=customTheme.activeThemeData["Theme"]["Settings"]["ButtonHoverColor"]
        )
        self.midiResetMinSeekDelay.grid(row=7, column=0, padx=(173, 0), pady=(10, 0), sticky="nw")
        ToolTip.CreateToolTip(self.midiResetMinSeekDelay, text = 'Reset Min Seek Delay to 2.0s')

        self.midiMinSeekDelayEntry = ctk.CTkEntry(
            self.mainScrollFrame, placeholder_text="2.0", width=45, 
            font=customTheme.globalFont14, 
            text_color=customTheme.activeThemeData["Theme"]["Settings"]["TextColor"], 
            border_color=customTheme.activeThemeData["Theme"]["Settings"]["ValueBoxBorderColor"], 
            fg_color=customTheme.activeThemeData["Theme"]["Settings"]["ValueBoxBackColor"]
        )
        self.midiMinSeekDelayEntry.grid(row=7, column=0, padx=(125, 0), pady=(10, 0), sticky="nw")
        self.midiMinSeekDelayEntry.insert(0, str(configuration.configData.get('midiPlayer', {}).get('minSeekDelay', 2.0)))
        self.__class__.midiMinSeekDelayEntry = self.midiMinSeekDelayEntry
        ToolTip.CreateToolTip(self.midiMinSeekDelayEntry, text = 'Min Seek Delay Value')

        self.midiMinSeekDelayEntry.bind("<FocusOut>", lambda value: settingsFunctions.updateFromEntry("midiMinSeekDelay", value))
        self.midiMinSeekDelayEntry.bind("<KeyRelease>", lambda value: settingsFunctions.updateFromEntry("midiMinSeekDelay", value))
        self.midiMinSeekDelaySlider.bind("<ButtonRelease-1>", lambda value: settingsFunctions.updateFromEntry("midiMinSeekDelay", value))

        self.midiMaxSeekDelayLabel = ctk.CTkLabel(
            self.mainScrollFrame, text="Max Seek Delay (s)", fg_color="transparent", 
            font=customTheme.globalFont14, 
            text_color=customTheme.activeThemeData["Theme"]["Settings"]["TextColor"]
        )
        self.midiMaxSeekDelayLabel.grid(row=7, column=0, padx=(245, 0), pady=(5, 0), sticky="nw")

        self.midiMaxSeekDelaySlider = ctk.CTkSlider(
            self.mainScrollFrame, from_=0.0, to=10.0, width=190, command=lambda value: settingsFunctions.updateFromSlider("midiMaxSeekDelay", value), 
            fg_color=customTheme.activeThemeData["Theme"]["Settings"]["SliderBackColor"], 
            progress_color=customTheme.activeThemeData["Theme"]["Settings"]["SliderFillColor"], 
            button_color=customTheme.activeThemeData["Theme"]["Settings"]["SliderCircleColor"], 
            button_hover_color=customTheme.activeThemeData["Theme"]["Settings"]["SliderCircleHoverColor"]
        )
        self.midiMaxSeekDelaySlider.grid(row=7, column=0, padx=(240,0), pady=(42, 0), sticky="nw")
        self.midiMaxSeekDelaySlider.set(configuration.configData.get('midiPlayer', {}).get('maxSeekDelay', 3.0))
        self.__class__.midiMaxSeekDelaySlider = self.midiMaxSeekDelaySlider
        ToolTip.CreateToolTip(self.midiMaxSeekDelaySlider, text = 'Maximum random delay (seconds) when seeking')

        self.midiResetMaxSeekDelay = ctk.CTkButton(
            self.mainScrollFrame, image=customTheme.resetImageCTk, text="", width=30, 
            command=lambda: settingsFunctions.resetControl("midiMaxSeekDelay"), font=customTheme.globalFont14, 
            text_color=customTheme.activeThemeData["Theme"]["Settings"]["TextColor"], 
            fg_color=customTheme.activeThemeData["Theme"]["Settings"]["ButtonColor"], 
            hover_color=customTheme.activeThemeData["Theme"]["Settings"]["ButtonHoverColor"]
        )
        self.midiResetMaxSeekDelay.grid(row=7, column=0, padx=(393, 0), pady=(10, 0), sticky="nw")
        ToolTip.CreateToolTip(self.midiResetMaxSeekDelay, text = 'Reset Max Seek Delay to 3.0s')

        self.midiMaxSeekDelayEntry = ctk.CTkEntry(
            self.mainScrollFrame, placeholder_text="3.0", width=45, 
            font=customTheme.globalFont14, 
            text_color=customTheme.activeThemeData["Theme"]["Settings"]["TextColor"], 
            border_color=customTheme.activeThemeData["Theme"]["Settings"]["ValueBoxBorderColor"], 
            fg_color=customTheme.activeThemeData["Theme"]["Settings"]["ValueBoxBackColor"]
        )
        self.midiMaxSeekDelayEntry.grid(row=7, column=0, padx=(345, 0), pady=(10, 0), sticky="nw")
        self.midiMaxSeekDelayEntry.insert(0, str(configuration.configData.get('midiPlayer', {}).get('maxSeekDelay', 3.0)))
        self.__class__.midiMaxSeekDelayEntry = self.midiMaxSeekDelayEntry
        ToolTip.CreateToolTip(self.midiMaxSeekDelayEntry, text = 'Max Seek Delay Value')

        self.midiMaxSeekDelayEntry.bind("<FocusOut>", lambda value: settingsFunctions.updateFromEntry("midiMaxSeekDelay", value))
        self.midiMaxSeekDelayEntry.bind("<KeyRelease>", lambda value: settingsFunctions.updateFromEntry("midiMaxSeekDelay", value))
        self.midiMaxSeekDelaySlider.bind("<ButtonRelease-1>", lambda value: settingsFunctions.updateFromEntry("midiMaxSeekDelay", value))
        ...
        self.drumsSettingsLabel.grid(row=8, column=0, padx=(10, 0), pady=(10, 0), sticky="w")
        ...
        self.drumsLoopSongToggle.grid(row=9, column=0, padx=(20, 0), pady=(0, 0), sticky="nw")
        ...
        self.drumsReleaseOnPauseToggle.grid(row=10, column=0, padx=(20, 0), pady=(0, 0), sticky="nw")
        ...
        self.drumsClearMidiListButton.grid(row=8, column=0, padx=(0, 170), pady=(10, 0), sticky="e")
        ...
        self.drumsCustomHoldLengthToggle.grid(row=9, column=0, padx=(40,0), pady=(5, 0), sticky="s")
        ...
        self.drumsNoteLengthLabel.grid(row=10, column=0, padx=(212, 0), pady=(0, 0), sticky="nw")
        ...
        self.drumsNoteLengthSlider.grid(row=11, column=0, padx=(207,0), pady=(0, 0), sticky="nw")
        ...
        self.drumsResetNoteLength.grid(row=10, column=0, padx=(370, 0), pady=(0, 0), sticky="nw")
        ...
        self.drumsNoteLengthEntry.grid(row=10, column=0, padx=(307, 0), pady=(0, 0), sticky="nw")
        ...
        self.drumsRandomFailToggle.grid(row=11, column=0, padx=(100,0), pady=(20, 0), sticky="s")
        ...
        self.drumsSpeedFailLabel.grid(row=12, column=0, padx=(0,50), pady=(0, 15))
        ...
        self.drumsSpeedFailSlider.grid(row=12, column=0, padx=(207,0), pady=(37, 0), sticky="nw")
        ...
        self.drumsResetSpeedFailButton.grid(row=12, column=0, padx=(370, 0), pady=(5, 0), sticky="nw")
        ...
        self.drumsSpeedFailEntry.grid(row=12, column=0, padx=(0, 205), pady=(5, 0), sticky="ne")
        ...
        self.drumsDecreaseSizeLabel.grid(row=12, column=0, padx=(25, 0), pady=(0, 0), sticky="nw")
        ...
        self.drumsDecreaseSizeSlider.grid(row=12, column=0, padx=(20,0), pady=(37, 0), sticky="nw")
        ...
        self.drumsResetDecreaseSize.grid(row=12, column=0, padx=(173, 0), pady=(5, 0), sticky="nw")
        ...
        self.drumsDecreaseSizeEntry.grid(row=12, column=0, padx=(135, 0), pady=(5, 0), sticky="nw")
        ...
        self.drumsModuleSelectorText.grid(row=11, column=0, padx=(25, 0), pady=(0, 35), sticky="sw")
        ...
        self.drumsModuleSelector.grid(row=11, column=0, padx=(20, 0), pady=(30, 10), sticky="sw")
        ...
        self.appUISettingsLabel.grid(row=13, column=0, padx=(10, 0), pady=(10, 0), sticky="w")
        ...
        self.topMostToggle.grid(row=14, column=0, padx=(20, 0), pady=(0, 0), sticky="nw")
        ...
        self.consoleToggle.grid(row=14, column=0, padx=(20, 0), pady=(25, 0), sticky="nw")
        ...
        self.tooltipToggle.grid(row=14, column=0, padx=(20, 0), pady=(50, 0), sticky="nw")
        ...
        self.timestampToggle.grid(row=14, column=0, padx=(20, 0), pady=(75, 0), sticky="nw")
        ...
        self.openConsoleButton.grid(row=14, column=0, padx=(280, 0), pady=(0, 0), sticky="nw")
        ...
        self.closeConsoleButton.grid(row=14, column=0, padx=(280, 0), pady=(50, 0), sticky="nw")
        ...
        self.themeSelectorLabel.grid(row=15, column=0, padx=(20, 0), pady=(10, 0), sticky="w")
        ...
        self.forceThemeToggle.grid(row=15, column=0, padx=(65, 0), pady=(0, 0), sticky="s")
        ...
        self.themeSelector.grid(row=16, column=0, padx=(0, 150), pady=(5, 15))
        ...
        self.hotkeySettingsLabel.grid(row=21, column=0, padx=(10, 0), pady=(10, 0), sticky="w")
        ...
        self.playHotkeyLabel.grid(row=22, column=0, padx=(33, 0), pady=(0, 0), sticky="w")
        ...
        self.pauseHotkeyLabel.grid(row=22, column=0, padx=(110, 0), pady=(0, 0), sticky="w")
        ...
        self.stopHotkeyLabel.grid(row=22, column=0, padx=(193, 0), pady=(0, 0), sticky="w")
        ...
        self.slowDownHotkeyLabel.grid(row=22, column=0, padx=(254, 0), pady=(0, 0), sticky="w")
        ...
        self.speedUpHotkeyLabel.grid(row=22, column=0, padx=(340, 0), pady=(0, 0), sticky="w")
        ...
        self.playHotkeyButton.grid(row=23, column=0, padx=(15, 165), pady=(0, 5), sticky="w")
        ...
        self.pauseHotkeyButton.grid(row=23, column=0, padx=(95, 165), pady=(0, 5), sticky="w")
        ...
        self.stopHotkeyButton.grid(row=23, column=0, padx=(175, 165), pady=(0, 5), sticky="w")
        ...
        self.speedUpHotkeyButton.grid(row=23, column=0, padx=(255, 165), pady=(0, 5), sticky="w")
        ...
        self.slowHotkeyButton.grid(row=23, column=0, padx=(337, 165), pady=(0, 5), sticky="w")
