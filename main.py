...
from ui.ytTranscribe import YtTranscribeTab
...
class App(ctk.CTk):
    def __init__(self):
        ...
        ytTranscribeFunctions.get_ffmpeg_path()
        ...
        self.frames = {
            ...
            "yt_transcribe": YtTranscribeTab(self.contentFrame),
            "history": HistoryTab(self.contentFrame)
        }
        ...
        self.navigationFrame.grid_rowconfigure(8, weight=1)
        ...
        # SIDEBAR > YT TRANSCRIBER BUTTON
        self.ytTranscribeButton = ctk.CTkButton(
            self.navigationFrame, corner_radius=0, height=40, border_spacing=10, text="YT Transcribe",
            fg_color=customTheme.activeThemeData["Theme"]["Navigation"]["TabButtonColor"], text_color=customTheme.activeThemeData["Theme"]["Navigation"]["TextColor"], hover_color=customTheme.activeThemeData["Theme"]["Navigation"]["TabButtonHoverColor"],
            image=customTheme.downloadImageFile, anchor="w", font=customTheme.globalFont14, command=lambda: self.showFrame("yt_transcribe")
        )
        self.ytTranscribeButton.grid(row=5, column=0, sticky="ew")

        # SIDEBAR > HISTORY BUTTON
        self.historyButton = ctk.CTkButton(
            self.navigationFrame, corner_radius=0, height=40, border_spacing=10, text="History",
            fg_color=customTheme.activeThemeData["Theme"]["Navigation"]["TabButtonColor"], text_color=customTheme.activeThemeData["Theme"]["Navigation"]["TextColor"], hover_color=customTheme.activeThemeData["Theme"]["Navigation"]["TabButtonHoverColor"],
            image=customTheme.downloadImageFile, anchor="w", font=customTheme.globalFont14, command=lambda: self.showFrame("history")
        )
        self.historyButton.grid(row=6, column=0, sticky="ew")
        ...
        self.settingsButton.grid(row=7, column=0, sticky="ew")
        ...
        self.customThemeWatermarkLine1.grid(row=9, column=0, padx=0, pady=(0, 0), sticky="n")
        ...
        self.customThemeWatermarkLine2.grid(row=10, column=0, padx=0, pady=(0, 0), sticky="n")
        ...
        if osName == "Darwin":
            ...
            if not isInput or not isAccessibility:
                ...
                self.permissionButton.grid(row=11, column=0)
        ...
        self.appInfoButton.grid(row=12, column=0, sticky="s")
        # -- SIDEBAR END --
